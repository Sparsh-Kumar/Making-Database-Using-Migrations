...
const tableModel = { tableName: 'venues' };
const tableModelCities = { tableName: 'cities' };
  ...
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      await queryInterface.createTable (tableModel, {
        ...
        CityId: { type: Sequelize.INTEGER, onUpdate: 'CASCADE', onDelete: 'CASCADE', references: {
          model: tableModelCities,
          key: 'Id',
          as: 'CityId'
        }},
